...
public class ManageProfileJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(lblManagerContact, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 470, -1, -1));
        ...
        add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 580, 110, 40));

        lblLogo.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        lblLogo.setText("Logo:");
        add(lblLogo, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 110, -1, -1));

        lblType.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        lblType.setText("Type:");
        add(lblType, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 510, 70, 30));

        optionsType.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        add(optionsType, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 510, 230, 40));
        ...
        add(imgLogo, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 140, 158, 150));
        ...
        add(btnAttach, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 300, 110, -1));

        lblName.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        lblName.setText("Name:");
        add(lblName, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 120, -1, -1));
        ...
        add(btnRemove, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 300, -1, -1));

        lblUsername.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        lblUsername.setText("Username:");
        add(lblUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 170, -1, -1));

        txtName.setEditable(false);
        txtName.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 110, 230, 40));

        txtUsername.setEditable(false);
        txtUsername.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        add(txtUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 160, 230, 40));

        txtPassword.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 210, 230, 40));

        lblPassword.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        lblPassword.setText("Password:");
        add(lblPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 220, -1, -1));

        txtDescription.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        add(txtDescription, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 260, 230, 40));

        lblDescription.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        lblDescription.setText("Description:");
        add(lblDescription, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 270, -1, -1));

        txtHq.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        add(txtHq, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 310, 230, 40));

        lblHq.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        lblHq.setText("Location Headquarters:");
        add(lblHq, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 320, -1, -1));

        txtManagerName.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        add(txtManagerName, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 360, 230, 40));

        lblManagerName.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        lblManagerName.setText("Manager Name:");
        add(lblManagerName, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 370, -1, -1));

        txtManagerEmail.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        add(txtManagerEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 410, 230, 40));

        lblManagerEmail.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        lblManagerEmail.setText("Manager Email:");
        add(lblManagerEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 420, -1, -1));

        txtManagerContact.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        add(txtManagerContact, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 460, 230, 40));
        ...
        add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 580, 110, 40));
